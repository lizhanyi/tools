...
/* harmony default export */ __webpack_exports__["b"] = (Class2type);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__memory__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__superDate__ = __webpack_require__(10);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Memory", function() { return __WEBPACK_IMPORTED_MODULE_0__memory__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "NumToZh_cn", function() { return __WEBPACK_IMPORTED_MODULE_1__numToZh_cn__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Class2type", function() { return __WEBPACK_IMPORTED_MODULE_4__class2type__["b"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "class2type", function() { return __WEBPACK_IMPORTED_MODULE_4__class2type__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "SuperDate", function() { return __WEBPACK_IMPORTED_MODULE_5__superDate__["a"]; });
...
function () {
  ...
  _createClass(Memory, [{
    ...
    value: function _filterFields(value, replacer) {
      ...
      if (Object(__WEBPACK_IMPORTED_MODULE_0__class2type__["c" /* isArray */])(replacer)) {
        if (Object(__WEBPACK_IMPORTED_MODULE_0__class2type__["d" /* isObject */])(value)) {
          return JSON.stringify(ret, replacer);
        }

        if (Object(__WEBPACK_IMPORTED_MODULE_0__class2type__["c" /* isArray */])(value) && Object(__WEBPACK_IMPORTED_MODULE_0__class2type__["d" /* isObject */])(value[0])) {
    ...
    value: function _getIntance(type, key, that) {
      ...
      if (Object(__WEBPACK_IMPORTED_MODULE_0__class2type__["e" /* isUndefined */])(type)) return;
...
function () {
  ...
  _createClass(URL, [{
    ...
    value: function set(opt, url) {
      if (!Object(__WEBPACK_IMPORTED_MODULE_0__class2type__["d" /* isObject */])(opt)) {
...
function () {
  ...
  function SuperDate(date) {
    ...
    _defineProperty(this, "types", __WEBPACK_IMPORTED_MODULE_1__constant__["b" /* types */]);

    _defineProperty(this, "map", __WEBPACK_IMPORTED_MODULE_1__constant__["a" /* map */]);
  ...
  _createClass(SuperDate, [{
    ...
    value: function format() {
      ...
      var maxDays = this.getMaxDay(year, month); // 当前天数大于 最大天数

      day = day > maxDays ? maxDays : day; // 月份 大于 12 
    ...
    value: function beforeYears(num) {
      var _this$dates = _slicedToArray(this.dates, 3),
          year = _this$dates[0],
          month = _this$dates[1],
          day = _this$dates[2];

      var maxDays = this.getMaxDay(year, month); // 当前日期
      ...
      this.result = [year + num, month, day].join('-');
      return this;
    }
    /**
     *  获取当前的时间的前些天、月、年
    ...
    key: "before",
    value: function before(num, type) {
      if (!this.types.includes(type)) {
        throw 'Expected type is wrong';
      }

      return this["before".concat(this.map[__WEBPACK_IMPORTED_MODULE_0__unit__["b" /* tool */].toUpper(type, true)], "s")](num);
    }
  }, {
    key: "afterYears",
    ...
    key: "after",
    value: function after(num) {
      return this['after' + __WEBPACK_IMPORTED_MODULE_0__unit__["b" /* tool */].toUpper(type) + 's'](num);
    }
    /**
     * 功能： 日期加
     * num: 自然数
